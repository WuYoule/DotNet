...
namespace BLLA
{
    ...
    public partial class Ou_RolePermisson : BaseBLL<MODEL.Ou_RolePermission>, IBLL.IOu_RolePermissonBLL
    {
        public override void SetDAL()
        {
            idal = DBSession.IOu_RolePermissonDAL;
        }
    }
    public partial class Ou_UserInfo : BaseBLL<MODEL.Ou_UserInfo>, IBLL.IOu_UserInfoBLL
    {
        public Ou_UserInfo() {
            //IDAL.IDBSession d=null;
            //idal = d.IOu_UserInfoDAL;
    ...
    public partial class Ou_UserVipPermisson : BaseBLL<MODEL.Ou_UserVipPermission>, IBLL.IOu_UserVipPermissonBLL
    {
        public override void SetDAL()
        {
